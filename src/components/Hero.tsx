    ...
    <div className="h-[100dvh] w-full relative overflow-hidden font-sans flex flex-col ">
      ...
      >
        <div className="absolute left-3 sm:left-10 md:left-16 bottom-20 md:bottom-28 hidden sm:flex flex-col gap-3 md:gap-4 z-20">
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 rounded-full bg-[#e0e0e0] flex items-center justify-center hover:scale-110 hover:bg-white transition-all shadow-lg">
          ...
          <a href="https://discord.com" target="_blank" rel="noopener noreferrer" className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 rounded-full bg-[#e0e0e0] flex items-center justify-center hover:scale-110 hover:bg-white transition-all shadow-lg">
        ...
        <main className=
          "flex flex-col items-center relative z-10 px-4 w-full max-w-7xl mx-auto pb-4 md:pb-8 pt-24 md:pt-28">
          ...
          <div className="flex sm:hidden flex-col items-center justify-center gap-3 mt-4 mb-2 w-full z-20 ">
            <div className="flex flex-row gap-6 items-center">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-[#e0e0e0] flex items-center justify-center hover:scale-110 hover:bg-white transition-all shadow-lg shrink-0">
                <svg className="w-4 h-46 text-black" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" /></svg>
              </a>
